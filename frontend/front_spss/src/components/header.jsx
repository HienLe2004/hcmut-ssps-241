...
const Header = () => {
    return (
        <header className="flex items-center justify-between px-5 py-3 w-full bg-cyan-600 text-blue-900 font-bold">
        {/* Logo */}
        ...
        <div className="flex gap-4">
          ...
          <button className="px-5 py-3 bg-gray-200 text-blue-900 rounded-lg hover:bg-gray-300 transition duration-200">
            Đăng ký
          </button>
        </div>
      </header>
